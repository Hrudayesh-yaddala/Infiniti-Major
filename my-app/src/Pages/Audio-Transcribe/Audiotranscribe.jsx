...
const Audiotranscribe = () => {
  ...
  return (
    <div>
        ...
        <div className='flex h-screen p-32 space-x-5 bg-gradient-to-tl bg-white'>

      
            <div className='w-1/2 bg-[#ffa781]  justify-center items-center rounded-lg border-2 border-[#5b0e2d]'>
