...
import summarization from '../Images/summarizatino.png';
    ...
    return (
        <div>
            <section className="mb-32 text-center">
                ...
                <div className="grid md:grid-cols-3 justify-center place-content-center">
                    <div className="mb-6 lg:mb-0">
                        <div className=" w-80 block rounded-lg bg-white  dark:bg-neutral-700">
                            <div className="flex">
                    ...
                    <div className="mb-6 lg:mb-0">
                        <div className="w-80 rounded-lg bg-white  dark:bg-neutral-700">
                            <div className="flex">
                                <div className="relative mx-4 -mt-4 w-72 overflow-hidden rounded-lg bg-cover bg-no-repeat ">
                    ...
                    <div className="mb-6 lg:mb-0">
                        <div className="w-80 rounded-lg bg-white  dark:bg-neutral-700">
                            ...
                            <div className="p-6">
                                <h5 className="mb-2 text-lg font-bold">Text summarization</h5>                       
                            </div>
                        </div>
                    </div>
                    <div className="mb-6 lg:mb-0">
