      ...
      <nav className="px-4 lg:px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="pr-10 flex space-x-6 justify-center">
            ...
            >
              <div className="text-lg text-black ml-2 flex items-center text-black text-lg  hover:bg-[#5b0e2d] hover:text-white rounded-md p-2 cursor-pointer font-medium transition delay-100">
                  Audio Conversion
